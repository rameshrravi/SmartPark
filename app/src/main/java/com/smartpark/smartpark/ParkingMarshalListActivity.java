...
public class ParkingMarshalListActivity extends AppCompatActivity {


    RecyclerView recyclerView;
    List<ParkingMarshalModel> parkingMarshalModelList=new ArrayList<>();
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_parking_marshal_list);
        ...
        recyclerView = findViewById(R.id.recyclerview_parking_marshal);

        searchView=(SearchView)findViewById(R.id.search_view);
        precinctsModel= (PrecinctsModel) getIntent().getSerializableExtra("Precincts");

        editor.putString(StringConstants.prefPrecinctID,precinctsModel.getId());
        editor.commit();
        editor.apply();;

        searchView.setIconifiedByDefault(false);
        searchView.setQueryHint("Search By Parking Marshal Name");
    ...
    public void getSiteManagersList(){
        final ProgressDialog pDialog=new ProgressDialog(ParkingMarshalListActivity.this);
        ...
        RequestQueue requestQueue = Volley.newRequestQueue(ParkingMarshalListActivity.this);
        ...
        StringRequest MyStringRequest = new StringRequest(Request.Method.POST, StringConstants.mainUrl , new Response.Listener<String>() {
                        ...
                        if(responseArray.length()>0){
                            ...
                            if(object.has("status")){
                                ...
                                if(status.equals("success")){
                                    ...
                                    if(object.has("parking_marshal_list")){
                                        parkingMarshalModelList=new ArrayList<>();
                                        JSONArray siteManagersArray=object.getJSONArray("parking_marshal_list");
                                        for(int i=0;i<siteManagersArray.length();i++){
                                            parkingMarshalModel=new ParkingMarshalModel();
                                            JSONObject siteManagerObject=siteManagersArray.getJSONObject(i);
                                            parkingMarshalModel.setFirstName(siteManagerObject.getString("first_name"));
                                            parkingMarshalModel.setLastName(siteManagerObject.getString("last_name"));
                                            parkingMarshalModel.setLoginID(siteManagerObject.getString("login_id"));
                                            parkingMarshalModel.setPassword(siteManagerObject.getString("password"));
                                            parkingMarshalModel.setPhoneNo(siteManagerObject.getString("phoneno"));
                                            parkingMarshalModel.setLogoutPin(siteManagerObject.getString("logoutpin"));

                                            parkingMarshalModelList.add(parkingMarshalModel);
                                        }

                                         enforceAdapter = new SiteManagerAdapter(ParkingMarshalListActivity.this, parkingMarshalModelList);
            ...
            protected Map<String, String> getParams() {
                ...
                MyData.put("method", "parkingmarshallist");
    ...
    public void showAlertDialog(String message){
        final AlertDialog.Builder alertDialogBuilder = new AlertDialog.Builder(ParkingMarshalListActivity.this);
    ...
    public class SiteManagerAdapter extends RecyclerView.Adapter<SiteManagerAdapter.MyViewHolder> implements Filterable {
        ...
        private List<ParkingMarshalModel> siteManagerModelList;
        private List<ParkingMarshalModel> filteredSiteManagerModelList;

        Context context;
        int row_index=-1;

        public SiteManagerAdapter(Context context, List<ParkingMarshalModel> siteManagerModelList){
        ...
        public void onBindViewHolder(@NonNull final SiteManagerAdapter.MyViewHolder holder, int position) {
            final ParkingMarshalModel siteManagerModel = filteredSiteManagerModelList.get(position);
            ...
            holder.linearLayoutContainer.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View view) {
                    ...
                    Intent i =new Intent(context,ParkingMarshalLoginActivity.class);
            ...
            return new Filter() {
                ...
                protected FilterResults performFiltering(CharSequence charSequence) {
                    ...
                    if (charString.isEmpty()) {
                        ...
                        List<ParkingMarshalModel> filteredList = new ArrayList<>();
                        for (ParkingMarshalModel row : siteManagerModelList) {
                ...
                protected void publishResults(CharSequence charSequence, FilterResults filterResults) {
                    filteredSiteManagerModelList = (ArrayList<ParkingMarshalModel>) filterResults.values;
