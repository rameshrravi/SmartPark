...
public class SiteManagerActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        searchView.setQueryHint("Search Site Manager Name");
    ...
    public void getSiteManagersList(){
        final ProgressDialog pDialog=new ProgressDialog(SiteManagerActivity.this);
        ...
        RequestQueue requestQueue = Volley.newRequestQueue(SiteManagerActivity.this);
        ...
        StringRequest MyStringRequest = new StringRequest(Request.Method.POST, StringConstants.mainUrl , new Response.Listener<String>() {
                        ...
                        if(responseArray.length()>0){
                            ...
                            if(object.has("status")){
                                ...
                                if(status.equals("success")){
                                    ...
                                    if(object.has("site_manage_list")){
                                        siteManagerModelList=new ArrayList<>();
                                        JSONArray siteManagersArray=object.getJSONArray("site_manage_list");
                                        for(int i=0;i<siteManagersArray.length();i++){
                                          ...
                                          enforceAdapter = new SiteManagerAdapter(SiteManagerActivity.this, siteManagerModelList);
            ...
            protected Map<String, String> getParams() {
                ...
                MyData.put("method", "get_site_manager");
    ...
    public void showAlertDialog(String message){
        final AlertDialog.Builder alertDialogBuilder = new AlertDialog.Builder(SiteManagerActivity.this);
        ...
        public void onBindViewHolder(@NonNull final SiteManagerAdapter.MyViewHolder holder, int position) {
            ...
            holder.linearLayoutContainer.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View view) {
                    ...
                    Intent i =new Intent(context,SiteManagerLoginActivity.class);
